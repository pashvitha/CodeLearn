...
async function loadProgress() {
    ...
    try {
        ...
        // Fetch all data
        let progressRes = await fetch("http://localhost:5000/progress");
        let usersRes = await fetch("http://localhost:5000/users");
        let challengesRes = await fetch("http://localhost:5000/challenges");
